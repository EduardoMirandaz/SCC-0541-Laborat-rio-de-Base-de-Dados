...
CREATE TABLE LAPTIMES (
	...
	CONSTRAINT PK_LAPTIMES PRIMARY KEY(RACE_ID, DRIVER_ID, LAP),
  	FOREIGN KEY (RACE_ID) REFERENCES RACES (RACES_ID) ON DELETE CASCADE, 
...
CREATE TABLE QUALIFYING (
	...
	CONSTRAINT PK_QUALIFYING PRIMARY KEY(QUALIFYING_ID),
  		FOREIGN KEY (RACE_ID) REFERENCES RACES (RACES_ID) ON DELETE CASCADE,
  		FOREIGN KEY (DRIVER_ID) REFERENCES DRIVER (DRIVER_ID) ON DELETE CASCADE,
  		FOREIGN KEY (CONSTRUCTOR_ID) REFERENCES CONSTRUCTORS (CONSTRUCTOR_ID) ON DELETE SET NULL
...
DROP TABLE public.airports CASCADE;

DROP TABLE public.circuits CASCADE;

DROP TABLE public.constructors CASCADE;

DROP TABLE public.countries CASCADE;

DROP TABLE public.driver CASCADE;

DROP TABLE public.driver_standings CASCADE;

DROP TABLE public.geocities15k CASCADE;

DROP TABLE public.laptimes CASCADE;

DROP TABLE public.pitstops CASCADE;

DROP TABLE public.qualifying CASCADE;

DROP TABLE public.races CASCADE;

DROP TABLE public.results CASCADE;
